...
public class RemindersDatabase {
    ...
    public Cursor getAllRowsDate() {
        ...
        Cursor c = 	db.query(true, DATABASE_TABLE, ALL_KEYS, null, null, null, null, RemindersDatabase.KEY_DATE + "," + RemindersDatabase.KEY_NAME_REMINDER + " COLLATE NOCASE" + "," + RemindersDatabase.KEY_LOCATION + " COLLATE NOCASE" + " ASC", null);
