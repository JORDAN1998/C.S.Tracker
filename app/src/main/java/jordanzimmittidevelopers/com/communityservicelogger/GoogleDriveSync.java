...
// GoogleDriveSync Class Created By Jordan Zimmitti 3-12-17//
public class GoogleDriveSync extends AppCompatActivity {
    ...
    // SyncEvents Class Created By Jordan Zimmitti 3-12-17 / Class For Syncing Events With Google Drive//
    public class SyncEvents extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        private void backupEvents() {
            ...
            } catch (Exception ignored) {Toast.makeText(getApplicationContext(), "Failed To Backup: You Must Have At Least One Event To Backup Database To Drive", Toast.LENGTH_SHORT).show();}
        }
        ...
        private void syncFile() {
            ...
            for (File file : localEventsBackupFolder.listFiles()) {
                if (file.isFile()) {
                    ...
                    }   catch (Exception ignored) {Toast.makeText(getApplicationContext(), "Failed: Local File Or Meta File Does not Exist", Toast.LENGTH_SHORT).show();}
                }
            }
        ...
        private void writeToExternalStorage() {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(SyncEvents.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
            }
        }
        ...
        private ResultCallback<DriveApi.DriveContentsResult> downloadCloudEventsBackupFile = new ResultCallback<DriveApi.DriveContentsResult>() {
            ...
            public void onResult(@NonNull DriveApi.DriveContentsResult result) {
                ...
                if (!result.getStatus().isSuccess()) {
                    ...
                    // Create Dialog//
                    new MaterialDialog.Builder(SyncEvents.this)
    ...
    // SyncReminders Class Created By Jordan Zimmitti 3-12-17 / Class For Syncing Reminders With Google Drive//
    ...
    // SyncReminders Class Created By Jordan Zimmitti 3-12-17 / Class For Syncing Reminders With Google Drive//
    private class SyncUsers extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
